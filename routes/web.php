...
use App\Http\Controllers\NewDealerTargetController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('beats-global-schedule-form', [BeatController::class, 'globalScheduleForm'])
    ...
    Route::get('location-geolocator', [BeatController::class, 'livelocation'])->name('location.geolocator');
    Route::get('user-punch-in-locator', [BeatController::class, 'punchInLocator'])->name('location.punch-in-locator');
    Route::get('customer-locator', [BeatController::class, 'customerLocator'])->name('location.customer-locator');
    Route::get('livelocation-all-users', [BeatController::class, 'allUsersLiveLocations'])->name('livelocation.all-users');
    //Attendance
...
Route::post('ajax/user-cities-by-district', [TourController::class, 'ajaxUserCitiesByDistrict'])->name('tours.ajaxUserCitiesByDistrict');
    ...
    Route::post('customer-calling/manual-call', [CallManagementController::class, 'createManualCall'])->name('customer-calling.manual-call');
    ...
    Route::get('customer-call-history/{callLog}', [CallManagementController::class, 'customerCallHistoryDetail'])->name('customer-call-history.show');
    Route::post('customer-call-history/{callLog}/transcribe', [CallManagementController::class, 'transcribeCustomerCall'])->name('customer-call-history.transcribe');
