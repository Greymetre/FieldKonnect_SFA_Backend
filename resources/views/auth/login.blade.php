...
<head>
  ...
  <title>FieldKonnect SFA Login</title>
  ...
  <main class="login-stage">
    ...
    <section class="panel">
      <div class="login">
        ...
        <div class="clientrow">
          <span class="client-name">FieldKonnect SFA</span>
        </div>

        <h2>Welcome back</h2>
        <p class="sub">Your entire field business, one login away.</p>
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="field">
            ...
            <div class="ctrl">
              <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ $loginValue }}" placeholder="you@company.com">
          ...
          <div class="login-row">
            <label class="rm">
              <input type="checkbox">
              <span class="bx"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6 9 17l-5-5"></path></svg></span>
              Keep me signed in
            </label>
            <a href="{{ route('password.request') }}" class="fg">Forgot password?</a>
          </div>
          @endif
          ...
          <div class="field">
            ...
            <div class="captcha-box">
              ...
              <button type="button" class="captcha-refresh" id="refresh-captcha">Refresh</button>
            </div>
        ...
        <div class="foot">&copy; {{ date('Y') }} <b>FieldKonnect SFA</b>. All rights reserved</div>
      </div>
    </section>
  </main>
